...
uint32_t can_decode_signal_as_uint32_t(CanFrame *msg, uint64_t start,
                                       uint64_t length, double scale,
                                       double offset);
...
uint16_t can_decode_signal_as_uint16_t(CanFrame *msg, uint64_t start,
                                       uint64_t length, double scale,
                                       double offset);
...
uint8_t can_decode_signal_as_uint8_t(CanFrame *msg, uint64_t start,
                                     uint64_t length, double scale,
                                     double offset);
...
double can_decode_signal_as_double(CanFrame *msg, uint64_t start,
                                   uint64_t length, double scale,
                                   double offset);
...
float can_decode_signal_as_float(CanFrame *msg, uint64_t start, uint64_t length,
...
int64_t can_decode_signal_as_int64_t(CanFrame *msg, uint64_t start,
                                     uint64_t length, double scale,
                                     double offset);
...
int32_t can_decode_signal_as_int32_t(CanFrame *msg, uint64_t start,
                                     uint64_t length, double scale,
                                     double offset);
...
int16_t can_decode_signal_as_int16_t(CanFrame *msg, uint64_t start,
                                     uint64_t length, double scale,
                                     double offset);
...
int8_t can_decode_signal_as_int8_t(CanFrame *msg, uint64_t start,
                                   uint64_t length, double scale,
                                   double offset);
